# code for Q1a
def return_coords(letter_coords):
                ...
                for letter6 in letters:
                    for letter7 in letters:
                        for letter8 in letters:
                            for letter9 in letters:
                                for letter10 in letters:
                                    if return_coords(f"{letter1}{letter2}{letter3}{letter4}{letter5}{letter6}{letter7}{letter8}{letter9}{letter10}") == [209, 217]:
                                        print(letter1,letter2,letter3,letter4,letter5,letter6,letter7,letter8,letter9,lettter10)
                                        exit()